...
controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    for (let index = 0; index < 12; index++) {
        playerChargedLaser = sprites.createProjectileFromSprite(img`
            ...
            . . . a a a a a a a a a a a . . 
            . . . . . . . . . . . . . . . . 
            `, protagSprite, randint(0, 100), randint(-100, 100))
...
forever(function () {
    music.playMelody("D A A A A A D A ", 400)
    music.playMelody("A B C5 B B B B B ", 400)
    music.playMelody("G A A D D D D D ", 400)
    music.playMelody("G E F E E E E E ", 400)
    music.playMelody("C D D D D D D D ", 400)
    music.playMelody("D D D D D D D D ", 400)
    music.playMelody("D A A A A A D A ", 400)
    music.playMelody("A B C5 B B B B B ", 400)
    music.playMelody("G A A D D D D D ", 400)
    music.playMelody("G E F E E E E E ", 400)
    music.playMelody("C D D D D D D D ", 400)
    music.playMelody("D D D D D D A B ", 400)
    music.playMelody("C5 C5 C5 C5 C5 C5 A C5 ", 400)
    music.playMelody("B A G G G G F G ", 400)
    music.playMelody("A A A A A A D A ", 400)
    music.playMelody("G F E E E E A B ", 400)
    music.playMelody("C5 C5 C5 C5 C5 C5 A C5 ", 400)
    music.playMelody("B C5 D D D D D D ", 400)
    music.playMelody("C C C C C C B C5 ", 400)
    music.playMelody("B A B B B B B B ", 400)
    music.playMelody("A A A A B B B B ", 400)
    music.playMelody("C5 C5 C5 C5 B B B B ", 400)
    music.playMelody("D A G A A A D D ", 400)
    music.playMelody("C A G A A A A A ", 400)
    music.playMelody("C5 A G A A A C5 C5 ", 400)
    music.playMelody("B F E F F F F F ", 400)
    music.playMelody("A E D E E E A A ", 400)
    music.playMelody("D A G A A A D D ", 400)
    music.playMelody("E E E E E E E E ", 400)
    music.playMelody("C5 C5 C5 C5 B B C5 B ", 400)
})
